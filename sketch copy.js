...
function preload() {
    ...
    // mySound = loadSound('https://raw.githubusercontent.com/riezong/streamofthought/master/data/Meeting_Again.mp3');
    // Preload video for minimal delay
    // titleVid = createVideo("https://riezong.github.io / streamofthought / data / Opening.mp4 ");
    // titleVid.hide();
}
...
function title() {
    ...
    titleVid.position(x, y);
    titleVid.size(width, height);
    titleVid.play();
    titleVid.speed(0);
    titleVid.onended(sayDone);
    videoPlaying = true;
}
